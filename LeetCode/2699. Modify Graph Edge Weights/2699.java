    ...
    private void runDijkstra(List<int[]>[] adjacencyList, int[][] edges, int[][] distances, int source, int difference,
        ...
        while (!priorityQueue.isEmpty()) {
            ...
            for (int[] neighbor : adjacencyList[currentNode]) {
                ...
                int newDistance = distances[currentNode][run] + weight;
                if (newDistance < distances[nextNode][run]) {
                    distances[nextNode][run] = newDistance;
 ...
 * }
 * 
 * private void runDijkstra(List<int[]>[] adjacencyList, int[][] edges, int[][]
 * distances, int source, int difference, int run) {
